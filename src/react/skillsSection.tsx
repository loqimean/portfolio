...
const iconAnimations: Array<{ skillName: string; start: string; end: string }> = [
  { skillName: "astro", start: "top 60%", end: "top 25%" },
  { skillName: "redis", start: "top 62%", end: "top 15%" },
  { skillName: "docker", start: "top 65%", end: "top 45%" },
  { skillName: "github", start: "top 55%", end: "top 35%" },
  { skillName: "arduino", start: "top 75%", end: "top 45%" },
  { skillName: "google-cloud", start: "top 55%", end: "top 35%" },
  { skillName: "rails", start: "top 55%", end: "top 25%" },
  { skillName: "js", start: "top 65%", end: "top 35%" },
  { skillName: "css", start: "top 65%", end: "top 35%" },
  { skillName: "ruby", start: "top 65%", end: "top 35%" },
  { skillName: "mjml", start: "top 65%", end: "top 35%" },
  { skillName: "elasticsearch", start: "top 95%", end: "top 55%" },
  { skillName: "bash", start: "top 85%", end: "top 55%" },
  { skillName: "react", start: "top 65%", end: "top 35%" },
  { skillName: "mysql", start: "top 45%", end: "top 15%" },
  { skillName: "aws", start: "top 45%", end: "top 15%" },
  { skillName: "html", start: "top 45%", end: "top 15%" },
  { skillName: "capistrano", start: "top 75%", end: "top 35%" },
  { skillName: "postgresql", start: "top 75%", end: "top 35%" },
];
