export default {
  ...
  about: "About Me",
  aboutText: "I’m a ukrainian full-stack developer, specializing in ruby on rails and modern web technologies.",
  ...
  contactForm: {
    ...
    attachFileHint: "PDF, images, or docs (max 10MB)",
    submit: "Send",
    submitting: "Sending...",
    success: "Thanks! Your message was sent.",
    error: "Something went wrong. Please try again.",
    errorRecaptcha: "Please complete the reCAPTCHA verification to continue.",
