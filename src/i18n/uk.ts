export default {
  ...
  about: "Про Мене",
  aboutText: "Я веб-розробник, який створює зручні та зрозумілі додатки. Працюю з сучасним стеком і перетворюю ідеї на практичні рішення через чистий, підтримуваний код.",
  aboutText2: "Покриваю як бекенд, так і фронтенд — будую швидкі, масштабовані продукти з фокусом на продуктивність і користувацький досвід.",
